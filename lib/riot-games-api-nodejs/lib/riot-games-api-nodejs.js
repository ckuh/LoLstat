...
var app = {
    ...
    timeout: 2500, // max execution time in milliseconds
...
app.league = {
    ...
    bySummonerEntry: function(summonerIds, vars, cb) {
        app.talk('api/lol/' + app.settings.region + '/v2.5/league/by-summoner/' + summonerIds + '/entry', vars, cb, app.settings.region)
    },
    /**
...
app.staticData = {
    ...
    champions: function(vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/champion', vars, cb, app.settings.global)
    },
    /**
    ...
    championsId: function(championId, vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/champion/' + championId, vars, cb, app.settings.global)
    },
    /**
    ...
    item: function(vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/item', vars, cb, app.settings.global)
    },
    /**
    ...
    itemId: function(itemId, vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/item/' + itemId, vars, cb, app.settings.global)
    },
    /**
    ...
    languages: function(vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/languages', vars, cb, app.settings.global)
    },
    /**
    ...
    mastery: function(vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/mastery', vars, cb, app.settings.global)
    },
    /**
    ...
    masteryId: function(masteryId, vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/mastery/' + masteryId, vars, cb, app.settings.global)
    },
    /**
    ...
    realm: function(vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/realm', vars, cb, app.settings.global)
    },
    /**
     * Retrieves mastery item by its unique id. (REST)
     *
    ...
    rune: function(vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/rune', vars, cb, app.settings.global)
    },
    /**
    ...
    runeId: function(runeId, vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/rune/' + runeId, vars, cb, app.settings.global)
    },
    /**
    ...
    summonerSpell: function(vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/summoner-spell', vars, cb, app.settings.global)
    },
    /**
    ...
    summonerSpellId: function(summonerSpellId, vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/summoner-spell/' + summonerSpellId, vars, cb, app.settings.global)
    },
    /**
    ...
    versions: function(vars, cb) {
        app.talk('api/lol/static-data/' + app.settings.region + '/v1.2/versions', vars, cb, app.settings.global)
    }
}
...
app.talk = function(path, fields, cb, host) {
